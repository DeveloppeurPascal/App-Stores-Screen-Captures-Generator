...
>
> La maintenance de ce projet est déplacée vers Codeberg sur https://codeberg.org/PatrickPremartin/App-Stores-Screen-Captures-Generator
>
...
> [!NOTE]
> Pour ouvrir ou intervenir sur un ticket de ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/App-Stores-Screen-Captures-Generator/issues
> Pour faire un PULL REQUEST sur ce projet, rendez-vous sur https://codeberg.org/PatrickPremartin/App-Stores-Screen-Captures-Generator/pulls
> Pour toute autre information ou me contacter vous pouvez aussi consulter le site Internet du projet sur https://appstoresscreencapturesgenerator.olfsoftware.fr ou son devlog sur https://appstoresscreencapturesgenerator.olfsoftware.fr/dev-corner.html
...
* [DeveloppeurPascal/ASSCG-Data-Admin](https://github.com/DeveloppeurPascal/ASSCG-Data-Admin) doit être installé dans le sous dossier ./lib-externes/ASSCG-Data-Admin
...
L'export de la documentation est fait en HTML par [DocInsight](https://devjetsoftware.com/products/documentation-insight/) ou [PasDoc](https://pasdoc.github.io) vers le dossier /docs du dépôt. Vous y avez aussi [accès en ligne](https://developpeurpascal.github.io/App-Stores-Screen-Captures-Generator) grâce à l'hébergement offert par GitHub Pages.

D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://appstoresscreencapturesgenerator.olfsoftware.fr) ou [le devlog du projet](https://developpeur-pascal.fr/app-stores-screen-captures-generator-asscg.html).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/App-Stores-Screen-Captures-Generator/issues) pour que je teste et tente de corriger ou fournir un contournement.
