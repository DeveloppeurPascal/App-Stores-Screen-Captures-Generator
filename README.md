...
>
> Maintenance of this project has been moved to Codeberg at https://codeberg.org/PatrickPremartin/App-Stores-Screen-Captures-Generator
>
...
> [!NOTE]
> To open or work on a ticket for this project, go to https://codeberg.org/PatrickPremartin/App-Stores-Screen-Captures-Generator/issues
> To make a PULL REQUEST on this project, go to https://codeberg.org/PatrickPremartin/App-Stores-Screen-Captures-Generator/pulls
> For any other information or to contact me, you can also visit the project website at https://appstoresscreencapturesgenerator.olfsoftware.fr or its devlog at https://appstoresscreencapturesgenerator.olfsoftware.fr/dev-corner.html.
...
Visit [the App Stores Screen Captures Generator website](https://appstoresscreencapturesgenerator.olfsoftware.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://appstoresscreencapturesgenerator.olfsoftware.fr) or [the project devlog](https://developpeur-pascal.fr/app-stores-screen-captures-generator-asscg.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/App-Stores-Screen-Captures-Generator/issues) so that I can test and try to correct or provide a workaround.
